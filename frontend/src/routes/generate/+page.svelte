<script lang="ts">
	...
	const genericAdvancedParameterSchema = $derived(isDoubao ? advancedParameterSchema.filter(p => p.key !== 'pitch_rate') : advancedParameterSchema);
