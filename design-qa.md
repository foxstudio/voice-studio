...
- Source visual truth: `docs/design/settings-search-layout-reference.png`
- Desktop implementation: `output/playwright/settings-acceptance/settings-desktop-1440x1024-v2.png`
- Mobile implementation: `output/playwright/settings-acceptance/settings-mobile-390x844-v2.png`
- Full-view comparison: `output/playwright/settings-acceptance/settings-desktop-comparison-v2.png`
- Focused comparison: `output/playwright/settings-acceptance/settings-desktop-focused-comparison-v2.png`
...
- Image quality and asset fidelity: the selected source's blue waveform product mark was cropped from the source visual and saved as `frontend/static/voice-studio-mark.png`. UI icons use the installed Lucide library. No placeholder, emoji, CSS-drawn, or handwritten SVG assets are used.
...
- `output/playwright/settings-acceptance/settings-desktop-1440x1024-v2.png`
- `output/playwright/settings-acceptance/settings-mobile-390x844-v2.png`
- `output/playwright/settings-acceptance/settings-desktop-comparison-v2.png`
...
- Desktop evidence: `output/playwright/settings-cloud-expanded.png`
- Mobile evidence: `output/playwright/settings-cloud-mobile.png`
