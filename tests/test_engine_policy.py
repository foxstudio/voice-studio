...
def test_all_cloud_engines_require_manual_replay_after_start():
    assert engine_policy.requires_manual_replay_after_start("mimo-v2.5-tts-preset") is True
    assert engine_policy.requires_manual_replay_after_start("doubao-tts-preset") is True
    assert engine_policy.requires_manual_replay_after_start("doubao-seed-audio-1.0") is True
    assert engine_policy.requires_manual_replay_after_start("indextts-v2") is False
...
def test_runner_kind_keeps_current_execution_families():
    ...
    assert engine_policy.runner_kind_for("qwen3-tts-mlx-0.6b") == "persistent_worker"
