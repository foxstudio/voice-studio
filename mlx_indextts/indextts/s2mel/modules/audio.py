# Source: retained from official IndexTTS 2.0 `indextts/s2mel/modules/audio.py`
# at ref 830f6f8f94a51fea23ab1d639027a86200075a4e. Voice Studio added this source
# notice without changing runtime logic. Applicable terms are in THIRD_PARTY_NOTICES.md.
