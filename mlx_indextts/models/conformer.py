# Source: adapted from official IndexTTS 1.5 `indextts/gpt/conformer_encoder.py`
# and `indextts/gpt/conformer/` at ref 9098497272d5803bae46cbaf5154cf2ba48f6866
# (Apache-2.0). Modified by MLX-IndexTTS for MLX and maintained by Voice Studio.
# See THIRD_PARTY_NOTICES.md for the retained license and change map.
