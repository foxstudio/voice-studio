...
# All rights reserved.
# Source: MLX adaptation aligned to official IndexTTS 2.0 S2Mel DiT and
# `indextts/s2mel/modules/gpt_fast/model.py` at ref
# 830f6f8f94a51fea23ab1d639027a86200075a4e. Modified by MLX-IndexTTS for MLX;
# maintained by Voice Studio. Applicable terms are in THIRD_PARTY_NOTICES.md.
