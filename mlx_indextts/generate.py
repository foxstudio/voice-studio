# Source: adapted from official IndexTTS 1.5 `indextts/infer.py` at ref
# 9098497272d5803bae46cbaf5154cf2ba48f6866 (Apache-2.0).
# Modified by MLX-IndexTTS to port inference from PyTorch to MLX, then modified
# by Voice Studio for its maintained runtime. See THIRD_PARTY_NOTICES.md.
