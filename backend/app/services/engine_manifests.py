    ...
    "doubao-tts-preset": EngineDetail(
        manifest=EngineManifest(
            ...
            parameter_schema=[
                ...
                ParameterSchema(key="sample_rate", label="采样率", type="select", default=24000, level="advanced", options=[{"label": f"{rate / 1000:g} kHz", "value": rate} for rate in [8000, 16000, 22050, 24000, 32000, 44100, 48000]], description="官方 sample_rate，可选 8–48 kHz"),
                ParameterSchema(key="bit_rate", label="MP3 码率", type="select", default=128000, level="advanced", options=[{"label": f"{rate // 1000} kbps", "value": rate} for rate in [64000, 96000, 128000, 160000]], description="官方 bit_rate，仅在 MP3 输出时生效，范围 64–160 kbps"),
