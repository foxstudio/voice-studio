...
BUILTIN_PRESETS: list[PresetTemplate] = [
    ...
    PresetTemplate(
        ...
        parameters={"language": "zh", "output_format": "wav", "mimo_voice": "mimo_default", "style_instruction": "自然、清晰、语速适中，像课程旁白一样读。"},
    ...
    PresetTemplate(
        ...
        parameters={"language": "zh", "output_format": "wav", "mimo_voice": "茉莉", "style_instruction": "温柔、亲切、略带微笑，语速不要太快。"},
    ...
    PresetTemplate(
        ...
        parameters={"language": "zh", "output_format": "wav", "voice_design_prompt": "年轻女性，声音清亮但不尖，语气有故事感，适合旁白和轻角色台词。", "optimize_text_preview": False},
    ...
    PresetTemplate(
        ...
        parameters={"language": "zh", "output_format": "wav", "style_instruction": "保持参考音色，语速适中，讲述感自然，重点句稍微放慢。"},
